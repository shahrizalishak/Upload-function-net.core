...
using eForm.MultiTenancy.HostDashboard;
...
namespace eForm.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(eFormDbContext context, SubscriptionPayment subscriptionPayment)
        {
