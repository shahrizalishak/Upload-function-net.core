...
using eForm.Authorization.Ldap;
using eForm.Authorization.Roles;
using eForm.Authorization.Users;
using eForm.Chat;
using eForm.Configuration;
using eForm.DashboardCustomization.Definitions;
using eForm.Debugging;
using eForm.Features;
using eForm.Friendships;
using eForm.Friendships.Cache;
using eForm.Localization;
using eForm.MultiTenancy;
using eForm.Net.Emailing;
using eForm.Notifications;
using eForm.WebHooks;

namespace eForm
{
    [DependsOn(
        typeof(eFormCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class eFormCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            eFormLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = eFormConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, eFormMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<eFormSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(eFormCoreModule).GetAssembly());
        }
