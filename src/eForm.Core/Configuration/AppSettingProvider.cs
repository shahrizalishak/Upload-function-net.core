...
using eForm.DashboardCustomization;
...
namespace eForm.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        {
            if (!eFormConsts.AllowTenantsToChangeEmailSettings)
            {
        ...
        private IEnumerable<SettingDefinition> GetTenantSettings()
        {
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings, GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings, eFormConsts.MultiTenancyEnabled? "true":"false"), scopes: SettingScopes.Tenant)
            };
        }
        ...
        private IEnumerable<SettingDefinition> GetDashboardSettings()
        {
            ...
            return new[]
            {
                new SettingDefinition(AppSettings.DashboardCustomization.Configuration +"."+ eFormDashboardCustomizationConsts.Applications.Mvc, mvcDefaultSettingsJson, scopes: SettingScopes.User, isVisibleToClients: true),
                new SettingDefinition(AppSettings.DashboardCustomization.Configuration +"."+ eFormDashboardCustomizationConsts.Applications.Angular, angularDefaultSettingsJson, scopes: SettingScopes.User, isVisibleToClients: true)
            };
        }
        ...
        public List<Dashboard> GetDefaultMvcDashboardViews()
        {
            ...
            return new List<Dashboard>
            {
                new Dashboard
                {
                    DashboardName = eFormDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            Name = eFormDashboardCustomizationConsts.DefaultPageName,
                            Widgets = new List<Widget>
                            {
                                new Widget
                                {
                                    WidgetId = eFormDashboardCustomizationConsts.Widgets.Tenant.GeneralStats, // General Stats
                                    Height = 9,
                                    Width = 6,
                                    PositionX = 0,
                                    PositionY = 19
                                ...
                                new Widget
                                {
                                    WidgetId = eFormDashboardCustomizationConsts.Widgets.Tenant.ProfitShare, // Profit Share
                                    Height = 13,
                                    Width = 6,
                                    PositionX = 0,
                                    PositionY = 28
                                ...
                                new Widget
                                {
                                    WidgetId = eFormDashboardCustomizationConsts.Widgets.Tenant.MemberActivity, // Memeber Activity
                                    Height = 13,
                                    Width = 6,
                                    PositionX = 6,
                                    PositionY = 28
                                ...
                                new Widget
                                {
                                    WidgetId = eFormDashboardCustomizationConsts.Widgets.Tenant.RegionalStats, // Regional Stats
                                    Height = 14,
                                    Width = 6,
                                    PositionX = 6,
                                    PositionY = 5
                                ...
                                new Widget
                                {
                                    WidgetId = eFormDashboardCustomizationConsts.Widgets.Tenant.DailySales, // Daily Sales
                                    Height = 9,
                                    Width = 6,
                                    PositionX = 6,
                                    PositionY = 19
                                ...
                                new Widget
                                {
                                    WidgetId = eFormDashboardCustomizationConsts.Widgets.Tenant.TopStats, // Top Stats
                                    Height = 5,
                                    Width = 12,
                                    PositionX = 0,
                                    PositionY = 0
                                ...
                                new Widget
                                {
                                    WidgetId = eFormDashboardCustomizationConsts.Widgets.Tenant.SalesSummary, // Sales Summary
                                    Height = 14,
                                    Width = 6,
                                    PositionX = 0,
                                    PositionY = 5
                ...
                new Dashboard
                {
                    DashboardName = eFormDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            ...
                            Widgets = new List<Widget>
                            {
                                new Widget
                                {
                                    WidgetId = eFormDashboardCustomizationConsts.Widgets.Host.TopStats, // Top Stats
                                    Height = 6,
                                    Width = 12,
                                    PositionX = 0,
                                    PositionY = 0
                                ...
                                new Widget
                                {
                                    WidgetId = eFormDashboardCustomizationConsts.Widgets.Host.IncomeStatistics, // Income Statistics
                                    Height = 11,
                                    Width = 7,
                                    PositionX = 0,
                                    PositionY = 6
                                ...
                                new Widget
                                {
                                    WidgetId = eFormDashboardCustomizationConsts.Widgets.Host.RecentTenants, // Recent tenants
                                    Height = 10,
                                    Width = 5,
                                    PositionX = 7,
                                    PositionY = 17
                                ...
                                new Widget
                                {
                                    WidgetId = eFormDashboardCustomizationConsts.Widgets.Host.SubscriptionExpiringTenants, // Subscription expiring tenants
                                    Height = 10,
                                    Width = 7,
                                    PositionX = 0,
                                    PositionY = 17
                                ...
                                new Widget
                                {
                                    WidgetId = eFormDashboardCustomizationConsts.Widgets.Host.EditionStatistics, // Edition statistics
                                    Height = 11,
                                    Width = 5,
                                    PositionX = 7,
                                    PositionY = 6
                    ...
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            ...
                            Widgets = new List<Widget>
                            {
                                ...
                                new Widget
                                {
                                    WidgetId = eFormDashboardCustomizationConsts.Widgets.Tenant.MemberActivity, // Member Activity
                                    Height = 11,
                                    Width = 6,
                                    PositionX = 6,
                                    PositionY = 24
                    ...
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            ...
                            Widgets = new List<Widget>
                            {
                                ...
                                {
                                    WidgetId =
                                        eFormDashboardCustomizationConsts.Widgets.Host.RecentTenants, // Recent tenants
                                    Height = 9,
                                    Width = 5,
                                    PositionX = 7,
                                    PositionY = 12
