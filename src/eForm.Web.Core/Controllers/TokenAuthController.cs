...
using eForm.Authentication.TwoFactor.Google;
...
using eForm.Web.Models.TokenAuth;
using eForm.Authorization.Impersonation;
using eForm.Authorization.Roles;
using eForm.Configuration;
using eForm.Debugging;
using eForm.Identity;
using eForm.Net.Sms;
using eForm.Notifications;
using eForm.Security.Recaptcha;
using eForm.Web.Authentication.External;
using eForm.Web.Common;

namespace eForm.Web.Controllers
{
    [Route("api/[controller]/[action]")]
    public class TokenAuthController : eFormControllerBase
    {
