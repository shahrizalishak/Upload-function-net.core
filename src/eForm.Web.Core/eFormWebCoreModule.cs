...
using eForm.Startup;
using eForm.Web.Authentication.JwtBearer;
using eForm.Web.Authentication.TwoFactor;
using eForm.Web.Chat.SignalR;
using eForm.Web.Configuration;
using eForm.Web.DashboardCustomization;
...
namespace eForm.Web
{
    ...
    public class eFormWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public eFormWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.DefaultNameOrConnectionString = _appConfiguration.GetConnectionString(
                eFormConsts.ConnectionStringName
            );
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(eFormApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(eFormWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(eFormWebCoreModule).Assembly);
        }
