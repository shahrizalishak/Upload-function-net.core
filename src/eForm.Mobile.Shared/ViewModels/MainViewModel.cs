...
using MvvmHelpers;
using eForm.Authorization.Users.Profile;
using eForm.Authorization.Users.Profile.Dto;
using eForm.Commands;
using eForm.Core.Threading;
using eForm.Models.NavigationMenu;
using eForm.Services.Navigation;
...
using eForm.ApiClient;
using eForm.Controls;
using eForm.Dto;
using eForm.Extensions;
using eForm.Localization;
using eForm.UI;
using eForm.UI.Assets;
using eForm.Views;
using DependencyResolver = eForm.Core.Dependency.DependencyResolver;
...
namespace eForm.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "eForm";
