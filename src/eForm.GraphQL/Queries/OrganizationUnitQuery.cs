...
using eForm.Core.Base;
using eForm.Core.Extensions;
using eForm.Dto;
using eForm.Types;

namespace eForm.Queries
{
    public class OrganizationUnitQuery : eFormQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
