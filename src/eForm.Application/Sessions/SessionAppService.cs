...
using eForm.UiCustomization;

namespace eForm.Sessions
{
    public class SessionAppService : eFormAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = eFormConsts.Currency,
                    CurrencySign = eFormConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = eFormConsts.AllowTenantsToChangeEmailSettings
                }
            };
