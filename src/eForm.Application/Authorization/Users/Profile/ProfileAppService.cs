...
using eForm.Authorization.Users.Profile.Cache;
using eForm.Authorization.Users.Profile.Dto;
using eForm.Friendships;
using eForm.Gdpr;
using eForm.Identity;
using eForm.Net.Sms;
using eForm.Security;
using eForm.Storage;
using eForm.Timing;

namespace eForm.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : eFormAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("eForm",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("eForm",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
