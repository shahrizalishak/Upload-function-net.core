...
using eForm.Migrations.Seed.Host;
...
namespace eForm.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : eFormAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<eFormDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(eFormConsts.ConnectionStringName).Value.ToString();
        }
