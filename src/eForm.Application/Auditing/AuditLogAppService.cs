...
using eForm.Auditing.Exporting;
using eForm.Authorization;
using eForm.Authorization.Users;
using eForm.Dto;
using eForm.EntityHistory;
using EntityHistoryHelper = eForm.EntityHistory.EntityHistoryHelper;

namespace eForm.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : eFormAppServiceBase, IAuditLogAppService
    {
