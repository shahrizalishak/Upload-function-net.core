...
namespace eForm.Web.Public.Startup
{
    [DependsOn(
        typeof(eFormWebCoreModule)
    )]
    public class eFormWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public eFormWebFrontEndModule(IWebHostEnvironment env, eFormEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(eFormWebFrontEndModule).GetAssembly());
        }
    }
}
