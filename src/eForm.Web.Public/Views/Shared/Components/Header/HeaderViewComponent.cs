...
using eForm.Url;
using eForm.Web.Public.Startup;
using eForm.Web.Session;

namespace eForm.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : eFormViewComponent
    {
