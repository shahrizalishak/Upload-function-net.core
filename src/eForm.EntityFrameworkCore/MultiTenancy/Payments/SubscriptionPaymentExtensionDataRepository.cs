...
{
    public class SubscriptionPaymentExtensionDataRepository : eFormRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<eFormDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
