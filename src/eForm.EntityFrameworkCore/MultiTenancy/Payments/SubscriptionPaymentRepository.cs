...
using eForm.EntityFrameworkCore.Repositories;

namespace eForm.MultiTenancy.Payments
{
    public class SubscriptionPaymentRepository : eFormRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<eFormDbContext> dbContextProvider)
