...
namespace eForm.Migrations
{
    ...
    [Migration("20200913154322_CreateFKTempUpload")]
    partial class CreateFKTempUpload
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eForm.EFlight.Flight", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("ApprovalPosition")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ValidationPhoneNo")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ValidationPosition")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("eForm.EFlight.FlightInformation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("DestinationArraival")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DestinationDeparture")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("TimeArriaval")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("eForm.EFlight.JobTitle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("eForm.EFlight.Purpose", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("eForm.EFlight.TravelAgent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("eForm.MultiTenancy.Payments.SubscriptionPaymentExtensionData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("eForm.Test.TempUpload", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("TempUpload");
                });

            modelBuilder.Entity("eForm.Test.TestEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("eForm.Test.TestUpload", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("eForm.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("eForm.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("eForm.EFlight.Flight", b =>
                {
                    b.HasOne("eForm.EFlight.JobTitle", "JobTitleFk")
                        .WithMany()
                        .HasForeignKey("JobTitleId");

                    b.HasOne("eForm.EFlight.Purpose", "PurposeFk")
                        .WithMany()
                        .HasForeignKey("PurposeId");

                    b.HasOne("eForm.EFlight.TravelAgent", "TravelAgentFk")
                        .WithMany()
            ...
            modelBuilder.Entity("eForm.Test.TempUpload", b =>
                {
                    b.HasOne("eForm.Test.TestEntity", "TestEntity")
                        .WithMany("TempUpload")
            ...
            modelBuilder.Entity("eForm.Test.TestUpload", b =>
                {
                    b.HasOne("eForm.Test.TestEntity", "TestName")
                        .WithMany("TestUpload")
